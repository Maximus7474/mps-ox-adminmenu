...
import { ArrowLeft, Ban, AlertTriangle, FileText, UserX, Shield } from 'lucide-react';
...
export function PlayerDetails() {
  ...
  return (
    <div className='space-y-6'>
      ...
      <p className='text-muted-foreground'>{player.steamId}</p>
                ...
                <CardHeader>
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                      <div className='flex items-center gap-2'>
                        <Label htmlFor={`char-${char.id}`}>Disabled</Label>
                        <Switch
                          id={`char-${char.id}`}
                  ...
                  <CardDescription>{char.identifier}</CardDescription>
                </CardHeader>
                <CardContent className='grid gap-2 text-sm sm:grid-cols-2'>
                  <div className='flex justify-between'>
                    <span className='text-muted-foreground'>Job:</span>
                    <Badge variant='outline'>{char.job}</Badge>
                  </div>
                  {char.gang && (
                    <div className='flex justify-between'>
                      <span className='text-muted-foreground'>Gang:</span>
                      <Badge variant='destructive'>{char.gang}</Badge>
                    </div>
                  )}
                  <div className='flex justify-between'>
                  ...
                  <div className='flex justify-between'>
                    ...
                    <span>${char.bankMoney.toLocaleString()}</span>
                  </div>
                  <div className='flex justify-between sm:col-span-2'>
                    <span className='text-muted-foreground'>Last Played:</span>
                    <span>{char.lastPlayed.toLocaleDateString()}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
